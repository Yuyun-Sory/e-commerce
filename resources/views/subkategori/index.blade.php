            ...
            <div class="col-md-12">
                <form class="form-kategori">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="deskripsi" class="form-control" placeholder="Deskripsi" cols="30" rows="10" required></textarea>
                    </div>
                    <div class="form-group">
                        <label for="">Gambar</label>
                        <input type="file" class="form-control" name="gambar" style="width: 200px;">
                    </div>
                    <div class="form-group">
            ...
            success : function({
                ...
                data.map(function (val, index) {
                    ...
                    <tr>
                        ...
                        <td>${val.deskripsi}</td>
                        <td><img src="/uploads/${val.gambar}" alt="" style="width: 100px;"></td>
                        <td>
